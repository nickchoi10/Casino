...
public class BPSEngine {
    ...
    public static void BPSRules2P() {
        System.out.println("The rules are simple. Boulder beats Shears, Shears beats Parchment, Parchment beats Boulder.\n" +
                "You will make a wager against the other player, winner gets all. All wagers must be equal\n" +
                "This means that if you win, you double your bet.\n\n");
    }
    ...
    public static void PvE() {
        ...
        } else System.out.println(ActiveAccount.activeAccounts.get(0).getAccountName() + " Lost.  :( ");
        quitPvE();
    }
    ...
    public static boolean winCondition(String winner, String player) {
        if (player == winner) return true;
        else return false;
    }
    ...
    public static String BPS1P(String player1){
        String bot = AIThrow();
