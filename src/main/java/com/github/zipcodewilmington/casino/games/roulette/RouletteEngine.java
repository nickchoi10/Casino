...
//    }
    ...
    public Scanner playerBetTwo (String playerInput) {
        System.out.println("What are betting on? For example, if you're betting on Odd, you can type, 'Odd'");
        Scanner scan = new Scanner(System.in);
        return scan;
    }
...
//        playerBetTwo();
//        spinWheel();
//    if (spinWheel() = (playerBetOne() || playerBetTwo()) {
//        System.out.println("We have a winner!");
//    } else
//    }
//    }
//        int wagerOne = betWagerOne();
//        spinWheel();
//        if playerBet() == spinWheel()
